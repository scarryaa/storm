...
impl VulkanRenderer {
    pub fn new(window: XWindow, display: *mut Display, width: u32, height: u32) -> Self {
        unsafe {
            ...
            let mut extension_names =
                ash_window::enumerate_required_extensions(window.display_handle()?.as_raw())
                    .unwrap()
                    .to_vec();
            let xlib_surface_extension = khr::XlibSurface::name();
